        ...
        <form method="POST" action="/listings" enctype="multipart/form-data">
            ...
            <div class="flex gap-10 mb-6">
                <div class="inline-flex items-center">
                    <label class="relative flex cursor-pointer items-center rounded-full p-3" for="clt"
                        data-ripple-dark="true">
                        <input id="clt" name="type" value="clt" type="radio" checked />
                    </label>
                ...
                <div class="inline-flex items-center">
                    <label class="relative flex cursor-pointer items-center rounded-full p-3" for="pj"
                        data-ripple-dark="true">
                        <input id="pj" name="type" value="pj" type="radio" />
                    </label>
                    <label class="mt-px cursor-pointer select-none font-light text-gray-700" for="html">
                        PJ
                    </label>
                ...
                <div class="inline-flex items-center">
                    <label class="relative flex cursor-pointer items-center rounded-full p-3" for="free"
                        data-ripple-dark="true">
                        <input id="free" name="type" value="free" type="radio" />
                    </label>
                    <label class="mt-px cursor-pointer select-none font-light text-gray-700" for="html">
                        Freelancer
                    </label>
