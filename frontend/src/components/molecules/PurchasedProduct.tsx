...
export const PurchasedProduct = () => {
    ...
    return (
        <Link href={`/products/${2}`} className="flex flex-col lg:grid grid-cols-12 gap-4 rounded-lg bg-gray-200 p-2 cursor-pointer transition-colors hover:bg-gray-300">
            ...
            <span className="col-span-2 text-left"><span className="lg:hidden">Preço unitário:</span>10.99 </span>
            <span className="col-span-2 text-left"><span className="lg:hidden">Quantidade:</span>30 </span>
        </Link>
